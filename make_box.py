...
def make_box(azi,len_prof,width_prof,center,box_file,text_file=None,number=None):
	'Function made to create a file with box and profile coordinates'
	' azi is in degree (counted clockwise from north), len_prof and width_prof in km, center is a string of'
	...
	P1=np.array([len_prof/2 * np.cos(beta), len_prof/2 * np.sin(beta)])
	P2=-P1
